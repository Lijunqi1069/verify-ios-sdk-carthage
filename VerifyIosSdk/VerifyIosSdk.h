...
//! Project version number for VerifyIosSdk.
FOUNDATION_EXPORT double VerifyIosSdkVersionNumber;

//! Project version string for VerifyIosSdk.
...
#import <VerifyIosSdk/NexmoClient.swift>